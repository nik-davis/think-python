...
def ex10_8():
    ...
    num_tests = int(input(' Run how many tests (1-99)?: '))
    num_iter = int(input(' How many iterations per test (~1000)?: '))
    num_people = int(input(' And how many people to simulate (~23)?: '))
    ...
    print(' Average probability after {0} tests is {1}%'.format(num_tests, average))
